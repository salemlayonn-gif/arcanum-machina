...
(function() {
  ...
  DATA.library = [
    ...
    { id: 'ch01',     anchor: '#ch01',     num: '1',   part: 1, title: 'First Steps',                     unlock: function(G) { return G.annotations.indexOf('the_first_ward') !== -1; } },
    { id: 'ch02',     anchor: '#ch02',     num: '2',  part: 1, title: 'The Tap',                         unlock: has('on_mana') },
    { id: 'ch03',     anchor: '#ch03',     num: '3', part: 1, title: 'The Language of Machines',        unlock: has('on_scrap') },
    { id: 'ch04',     anchor: '#ch04',     num: '4',  part: 1, title: 'The Road Is Not Safe',            unlock: has('first_fight') },
    { id: 'ch05',     anchor: '#ch05',     num: '5',   part: 1, title: 'Synthesis',                       unlock: has('first_core') },
    { id: 'ch06',     anchor: '#ch06',     num: '6',  part: 2, title: 'The Overgrown Road',              unlock: walked('overgrown_road') },
    { id: 'ch07',     anchor: '#ch07',     num: '7', part: 2, title: 'The Ruined Outpost',              unlock: walked('ruined_outpost') },
    { id: 'ch08',     anchor: '#ch08',     num: '8',part: 2, title: 'On the Broken Helpers',           unlock: has('district_arrival') },
    { id: 'ch09',     anchor: '#ch09',     num: '9',  part: 2, title: 'The Shattered Spire',             unlock: has('spire_cut') },
    { id: 'ch10',     anchor: '#ch10',     num: '10',   part: 2, title: 'The Deep Vault',                  unlock: has('vault_access') },
    { id: 'frag1',    anchor: '#frag1',    num: 'F1',  part: 3, title: 'Fragment I — Cycle 1,847',        unlock: decoded('memory_shard_first') },
    { id: 'frag2',    anchor: '#frag2',    num: 'F2',  part: 3, title: 'Fragment II — Cycle 8,203',       unlock: decoded('prestige1_lore') },
    { id: 'frag3',    anchor: '#frag3',    num: 'F3',  part: 3, title: 'Fragment III — Lirien Vaes',      unlock: decoded('prestige2_lore') },
    { id: 'frag4',    anchor: '#frag4',    num: 'F4',  part: 3, title: 'Fragment IV — The Final Coherent Log', unlock: decoded('prestige5_lore') },
    { id: 'frag5',    anchor: '#frag5',    num: 'F5',  part: 3, title: 'Fragment V — The Echo Stone',     unlock: decoded('veritas_fragment') },
    { id: 'ch11',     anchor: '#ch11',     num: '11',  part: 4, title: 'The First Awakening',             unlock: cycles(1) },
    { id: 'ch12',     anchor: '#ch12',     num: '12', part: 4, title: 'The Second Awakening',            unlock: cycles(2) },
    { id: 'ch13',     anchor: '#ch13',     num: '13',part: 4, title: 'The Third Awakening',             unlock: cycles(3) },
    { id: 'ch14',     anchor: '#ch14',     num: '14', part: 4, title: 'The Fourth Awakening',            unlock: cycles(4) },
    { id: 'ch15',     anchor: '#ch15',     num: '15',  part: 4, title: 'The Fifth Awakening',             unlock: cycles(5) },
    { id: 'ch16',     anchor: '#ch16',     num: '16', part: 4, title: 'The Sixth Awakening',             unlock: cycles(6) },
    ...
    { id: 'foreword', anchor: '#foreword', num: 'Fw',  part: 0, title: 'Foreword — Year 37',              unlock: ended, sealed: true },
